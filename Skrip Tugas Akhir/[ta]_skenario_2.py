...
Original file is located at
    https://colab.research.google.com/drive/1zw-yj6_-cMe0CRxjVZZ0kme8V_jPTO87

## Skenario 2 
### Dengan Conv 32, hidden layer 128, lr 0.01
"""
...
def define_model():
	model = Sequential()
	model.add(Conv2D(32, (3, 3), activation='relu', kernel_initializer=initializers.he_uniform(seed=1), padding='same', input_shape=(200, 200, 3)))
	model.add(MaxPooling2D((2, 2)))
	model.add(Flatten())
	model.add(Dense(128, activation='relu', kernel_initializer=initializers.he_uniform(seed=1)))
